...
<head>
  ...
  <title>HMS - Add Health Records</title>
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Health Records / </span>Add Health Records</h4>
            <div class="card">
              <h5 class="card-header">Add Health Records</h5>
              <?php
                        ...
                        <td>
                            <div class='dropdown'>
                                ...
                                <div class='dropdown-menu'>
                                    <a class='dropdown-item' href='add-records.php?id={$rows['id']}'><i class='bx bx-add-to-queue me-1'></i> Add Records</a>
                                </div>
                            </div>
                        </td>
                    </tr>";
