...
if (!isset($_SESSION['user_name'], $_SESSION['profile'])) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($result->num_rows > 0) {
    ...
    while ($existingCourse = $result->fetch_assoc()) {
    ...
    if ($courseExists) {
      ...
      $stmt = $conn->prepare("UPDATE course SET course = ?, acronym = ? WHERE id = ?");
      $stmt->bind_param("ssi", $course, $acronym, $id);
      $stmt->execute();

      if ($stmt->affected_rows > 0) {
        $message = "<div class='alert alert-success' role='alert'>The course has been edited successfully.</div>";
        $rows['course'] = $course;
        $rows['acronym'] = $acronym;
      } else {
        $message = "<div class='alert alert-warning' role='alert'>No information changes.</div>";
      }
    }
  } else {
    $message = "<div class='alert alert-warning' role='alert'>No course found.</div>";
  }
  $stmt->close();
}
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Courses / List of Courses / </span>Edit Courses</h4>
            <form method="post">
              <!-- edit students -->
              <div class="col-xxl">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <div class="input-group input-group-merge">
                          ...
                          <input type="text" class="form-control" id="course" name="course" placeholder="Bachelor of Science in Information Technology" aria-label="John Doe" value="<?php echo $rows['course'] ?>" required />
                        </div>
                      </div>
                    </div>
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <div class="input-group input-group-merge">
                          ...
                          <input type="text" class="form-control" id="acronym" name="acronym" placeholder="BSIT" aria-label="BSIT" value="<?php echo $rows['acronym'] ?>" required />
                        </div>
                      </div>
                    </div>
                    <div class="row justify-content-end">
                      <div class="col-sm-10">
                        ...
                        <a href="list-courses.php" class="btn btn-secondary">Back</a>
                      </div>
                    </div>
                  </div>
                </div>
